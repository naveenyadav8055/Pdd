...
public class SelfHelpIntroduction extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.self_help_introduction);
        ...
        nextButton.setOnClickListener(v -> {
            Intent intent = new Intent(SelfHelpIntroduction.this, SelfHelpBrushing.class);
