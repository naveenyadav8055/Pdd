...
public class SocialSkillImitation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.social_skill_imitation);
        ...
        nextButton.setOnClickListener(v -> {
            Intent intent = new Intent(SocialSkillImitation.this, SocialSkillAttention.class);
