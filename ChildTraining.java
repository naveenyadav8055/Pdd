...
public class ChildTraining extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_child_training);  // Ensure this matches your XML layout file
        ...
        btnSocialSkills.setOnClickListener(v -> {
            Intent intent = new Intent(ChildTraining.this, SocialSkills.class);
            startActivity(intent);
        });

        // Navigate to PlaySkillsActivity
        btnPlaySkills.setOnClickListener(v -> {
            Intent intent = new Intent(ChildTraining.this, PlaySkills.class);
            startActivity(intent);
        });

        // Navigate to SelfHelpSkillsActivity
        btnSelfHelpSkills.setOnClickListener(v -> {
            Intent intent = new Intent(ChildTraining.this, SelfHelpSkills.class);
            startActivity(intent);
        });

        // Navigate to BehavioralIssuesActivity
        btnBehavioralIssues.setOnClickListener(v -> {
            Intent intent = new Intent(ChildTraining.this, BehavioralIssues.class);
            startActivity(intent);
        });
    }
}
